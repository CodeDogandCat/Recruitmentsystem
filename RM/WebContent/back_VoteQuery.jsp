...
<!-- 				</td> -->
  ...
  <tr>
    ...
    <td height="846" valign="top" background="images/head_07.jpg" width="407">
		...
		<%out.println("<p align=left>&nbsp;&nbsp;&nbsp;&nbsp;<img src=images/icon.gif width=10 height=10>&nbsp;&nbsp;简历查看</p>");%><br>
		<form name="form" method="post" action="VoteServlet?method=2" onSubmit="return voteAdd()" enctype="multipart/form-data">
 ...
 <img alt="证件照" width="117" height="156" src="<%=voteForm.getZplj() %>">
    ...
    <tr>
      ...
      <%if(voteForm.getJlzt()==1){ %>
        <td >  <input name="jlzt" type="text" id="jlzt" readonly="readonly" value="通过"/></td>
          <%}else if(voteForm.getJlzt()==2){ %>
        <td >  <input name="jlzt" type="text" id="jlzt" readonly="readonly" value="不通过"/></td>
           <%}else if(voteForm.getJlzt()==0){ %>
        <td >  <input name="jlzt" type="text" id="jlzt" readonly="readonly" value="未审核"/></td>
     <%} %>
